...
const contactInfo = graduates.forEach(function(graduates){
...
zooAnimals.forEach(function(newNames){
  let answer = `Name: ${newNames.animal_name}, Scientific: ${newNames.scientific_name}`;
  animalNames.push(answer)
});
...
let lowerCase = []
lowerCase = zooAnimals.map(function(names){
...
largerPopulation = zooAnimals.filter(function(five){
  return five.population < 5;
})
...
*/
var populationTotal = [];
var populationTotal = zooAnimals.reduce(function(sum, current){
